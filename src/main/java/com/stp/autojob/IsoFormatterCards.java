...
public class IsoFormatterCards {
	private static final Logger logger = LoggerFactory.getLogger(IsoFormatterCards.class);
...
//			Date date = inputformat.parse(input);
	...
	public static void main(String[] args) {
		IsoFormatterCards test = new IsoFormatterCards();
	}
	...
	public static List<IsoV93Message> request1200STP_CARDS_NFS_ISS_RECON_TTUM(
			List<STP_CARDS_NFS_ISS_RECON_TTUM> array) {
		ArrayList<IsoV93Message> reqList = new ArrayList<IsoV93Message>();
		IsoV93Message obj1200 = null;
		for (STP_CARDS_NFS_ISS_RECON_TTUM req : array) {
			try {
...
//	 repeat transaction format
	public static List<IsoV93Message> request1201STP_CARDS_NFS_ISS_RECON_TTUMRepeat(
			List<STP_CARDS_NFS_ISS_RECON_TTUM> array) {
		ArrayList<IsoV93Message> reqList = new ArrayList<IsoV93Message>();
		IsoV93Message obj1200 = null;
		for (STP_CARDS_NFS_ISS_RECON_TTUM req : array) {
...
//	 repeat transaction format
	public static List<IsoV93Message> request1200STP_CARDS_NFS_ISS_RECON_TTUMEnquiry(
			List<STP_CARDS_NFS_ISS_RECON_TTUM> array) {
		ArrayList<IsoV93Message> reqList = new ArrayList<IsoV93Message>();
		IsoV93Message obj1200 = null;
		for (STP_CARDS_NFS_ISS_RECON_TTUM req : array) {
