...
@Service
public class ImpsScheduledTask {

	private static final Logger logger = LoggerFactory.getLogger(ImpsScheduledTask.class);
	@Autowired
...
//	@Scheduled(cron = "0 * * * * ?")
	public void executeTask() {
		logger.info("ImpsScheduledTask Scheduled task  start executed at: " + new Date());
	}

	public void PROCESSSTP_IMPS_TCC_DATA_IW() {
	...
	private int processRequestSTP_IMPS_TCC_DATA_IW(String requestType, String condition,
