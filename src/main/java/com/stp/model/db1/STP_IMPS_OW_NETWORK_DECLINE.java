...
@DynamicUpdate
@Entity
@Table(name = "stp_imps_ow_network_decline", indexes = {
		@Index(columnList = "refnumber,accountnumber,valuedate", name = "stp_imps_ow_network_decline_idx") })
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class STP_IMPS_OW_NETWORK_DECLINE {
