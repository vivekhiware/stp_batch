...
@DynamicUpdate
@Entity
@Table(name = "stp_imps_prearbi_report", indexes = {
		@Index(columnList = "refnumber,accountnumber,valuedate", name = "stp_imps_prearbi_report_idx") })
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class STP_IMPS_PREARBITRATION_REPORT {
