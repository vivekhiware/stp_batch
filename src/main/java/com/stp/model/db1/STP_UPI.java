...
@DynamicUpdate
@Entity
@Table(name = "stp_upi", indexes = { @Index(columnList = "accountnumber,valuedate", name = "stp_upi_idx") })
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class STP_UPI {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "stp_upiSeq")
	@SequenceGenerator(name = "stp_upiSeq", sequenceName = "stp_upiSeq", allocationSize = 1, initialValue = 1)
	private int id;
	...
	@Column(name = "valuedate", length = 50)
