...
@DynamicUpdate
@Entity
@Table(name = "stp_cards_nfs_iss_recon_ttum", indexes = {
		@Index(columnList = "refnumber,accountnumber,valuedate", name = "stp_cards_nfs_iss_recon_ttum_idx") })
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class STP_CARDS_NFS_ISS_RECON_TTUM {
