...
@DynamicUpdate
@Entity
@Table(name = "stp_imps_rcc_report_repraise", indexes = {
		@Index(columnList = "refnumber,accountnumber,valuedate", name = "stp_imps_rcc_report_repraise_idx") })
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class STP_IMPS_RCC_REPORT_REPRAISE {
